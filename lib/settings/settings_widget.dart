                ...
                child: Container(
                  ...
                  child: Padding(
                    ...
                    child: InkWell(
                      ...
                      onTap: () async {
                        logFirebaseEvent('SETTINGS_PAGE_Row_os8n206o_ON_TAP');
                ...
                child: Container(
                  ...
                  child: Padding(
                    ...
                    child: InkWell(
                      ...
                      highlightColor: Colors.transparent,
                      onTap: () async {
                        logFirebaseEvent('SETTINGS_PAGE_Row_yk0nnj3r_ON_TAP');
                ...
                child: Container(
                  ...
                  child: Padding(
                    ...
                    child: InkWell(
                      ...
                      highlightColor: Colors.transparent,
                      onTap: () async {
                        logFirebaseEvent('SETTINGS_PAGE_Row_o4qesgky_ON_TAP');
                        logFirebaseEvent('Row_auth');
                ...
                child: Container(
                  ...
                  child: Padding(
                    ...
                    child: InkWell(
                      ...
                      highlightColor: Colors.transparent,
                      onTap: () async {
                        logFirebaseEvent('SETTINGS_PAGE_Row_442srriq_ON_TAP');
                        logFirebaseEvent('Row_bottom_sheet');
                        await showModalBottomSheet(
                          isScrollControlled: true,
                          backgroundColor: Colors.transparent,
                ...
                child: Container(
                  ...
                  child: Padding(
                    ...
                    child: InkWell(
                      ...
                      highlightColor: Colors.transparent,
                      onTap: () async {
                        logFirebaseEvent('SETTINGS_PAGE_Row_pwc2zhcb_ON_TAP');
                  ...
                  children: [
                    Padding(
                      ...
                      child: InkWell(
                        ...
                        highlightColor: Colors.transparent,
                        onTap: () async {
                          logFirebaseEvent('SETTINGS_PAGE_Row_u9darpeb_ON_TAP');
                          logFirebaseEvent('Row_auth');
                          GoRouter.of(context).prepareAuthEvent();
                          await authManager.signOut();
                          GoRouter.of(context).clearRedirectLocation();
