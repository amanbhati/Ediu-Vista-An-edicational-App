                      ...
                      Align(
                        ...
                        child: Padding(
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              logFirebaseEvent(
                                  'SIGN_IN_COPY_PAGE_SIGN_UP_BTN_ON_TAP');
                              ...
                              final usersCreateData = createUsersRecordData(
                                ...
                                phoneNumber: _model.mobileController.text,
                                gender: _model.genderController.text,
                                course: _model.ageController.text,
                              );
                              ...
                              if (currentUserEmailVerified) {
                                ...
                                context.pushNamedAuth('TCCopy', mounted);
                              } else {
                                logFirebaseEvent('Button_show_snack_bar');
                                ScaffoldMessenger.of(context).showSnackBar(
                                  SnackBar(
                              ...
                              Align(
                                ...
                                child: Padding(
                                  ...
                                  child: InkWell(
                                    ...
                                    onTap: () async {
                                      logFirebaseEvent(
                                          'SIGN_IN_COPY_PAGE_Text_yr0ddy19_ON_TAP');
                                ...
                                children: [
                                  Padding(
                                    ...
                                    child: FFButtonWidget(
                                      onPressed: () async {
                                        logFirebaseEvent(
                                            'SIGN_IN_COPY_CONTINUE_WITH_GOOGLE_BTN_ON');
                                        logFirebaseEvent('Button_auth');
                                        GoRouter.of(context).prepareAuthEvent();
