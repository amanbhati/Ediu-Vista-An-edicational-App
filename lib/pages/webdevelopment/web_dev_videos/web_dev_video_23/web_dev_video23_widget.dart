...
import 'web_dev_video23_model.dart';
export 'web_dev_video23_model.dart';

class WebDevVideo23Widget extends StatefulWidget {
  const WebDevVideo23Widget({Key? key}) : super(key: key);

  @override
  _WebDevVideo23WidgetState createState() => _WebDevVideo23WidgetState();
}

class _WebDevVideo23WidgetState extends State<WebDevVideo23Widget> {
  late WebDevVideo23Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => WebDevVideo23Model());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'WebDevVideo_23'});
                        ...
                        child: Row(
                          ...
                          children: [
                            FlutterFlowIconButton(
                              ...
                              onPressed: () async {
                                logFirebaseEvent(
                                    'WEB_DEV_VIDEO_23_arrow_back_ICN_ON_TAP');
