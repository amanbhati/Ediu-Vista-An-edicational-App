...
import 'web_dev_video1_model.dart';
export 'web_dev_video1_model.dart';

class WebDevVideo1Widget extends StatefulWidget {
  const WebDevVideo1Widget({Key? key}) : super(key: key);

  @override
  _WebDevVideo1WidgetState createState() => _WebDevVideo1WidgetState();
}

class _WebDevVideo1WidgetState extends State<WebDevVideo1Widget> {
  late WebDevVideo1Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => WebDevVideo1Model());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'WebDevVideo_1'});
                        ...
                        child: Row(
                          ...
                          children: [
                            FlutterFlowIconButton(
                              ...
                              onPressed: () async {
                                logFirebaseEvent(
                                    'WEB_DEV_VIDEO_1_arrow_back_ICN_ON_TAP');
                            ...
                            Expanded(
                              child: Padding(
                                padding: EdgeInsetsDirectional.fromSTEB(
                                    15.0, 0.0, 10.0, 0.0),
                                child: Text(
                                  'Lecture 1 : Elements and attributes | HTML course',
                                  style: FlutterFlowTheme.of(context)
                                      .bodyMedium
                                      .override(
                                        fontFamily: 'Merriweather',
                                    ...
                                    children: [
                                      Padding(
                                        ...
                                        child: InkWell(
                                          ...
                                          onTap: () async {
                                            logFirebaseEvent(
                                                'WEB_DEV_VIDEO_1_PAGE_Row_zl0vp84u_ON_TAP');
                                            logFirebaseEvent('Row_navigate_to');

                                            context.pushNamed('WebDevVideo_2');
                                          },
                                          child: Row(
                                            mainAxisSize: MainAxisSize.max,
                                            children: [
                                                ...
                                                child: Padding(
                                                  padding: EdgeInsetsDirectional
                                                      .fromSTEB(
                                                          5.0, 0.0, 5.0, 0.0),
                                                  child: Text(
                                                    'Lecture 2 : List & Tables |HTML course',
                                      ...
                                      Padding(
                                        ...
                                        child: InkWell(
                                          ...
                                          onTap: () async {
                                            logFirebaseEvent(
                                                'WEB_DEV_VIDEO_1_PAGE_Row_9dcy96vm_ON_TAP');
                                            logFirebaseEvent('Row_navigate_to');

                                            context.pushNamed('WebDevVideo_3');
                                          },
                                          child: Row(
                                            mainAxisSize: MainAxisSize.max,
                                            children: [
