...
import 'web_dev_video33_model.dart';
export 'web_dev_video33_model.dart';

class WebDevVideo33Widget extends StatefulWidget {
  const WebDevVideo33Widget({Key? key}) : super(key: key);

  @override
  _WebDevVideo33WidgetState createState() => _WebDevVideo33WidgetState();
}

class _WebDevVideo33WidgetState extends State<WebDevVideo33Widget> {
  late WebDevVideo33Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => WebDevVideo33Model());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'WebDevVideo_33'});
                        ...
                        child: Row(
                          ...
                          children: [
                            FlutterFlowIconButton(
                              ...
                              onPressed: () async {
                                logFirebaseEvent(
                                    'WEB_DEV_VIDEO_33_arrow_back_ICN_ON_TAP');
