...
import 'web_dev_video29_model.dart';
export 'web_dev_video29_model.dart';

class WebDevVideo29Widget extends StatefulWidget {
  const WebDevVideo29Widget({Key? key}) : super(key: key);

  @override
  _WebDevVideo29WidgetState createState() => _WebDevVideo29WidgetState();
}

class _WebDevVideo29WidgetState extends State<WebDevVideo29Widget> {
  late WebDevVideo29Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => WebDevVideo29Model());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'WebDevVideo_29'});
                        ...
                        child: Row(
                          ...
                          children: [
                            FlutterFlowIconButton(
                              ...
                              onPressed: () async {
                                logFirebaseEvent(
                                    'WEB_DEV_VIDEO_29_arrow_back_ICN_ON_TAP');
