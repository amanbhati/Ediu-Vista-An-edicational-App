...
import 'web_dev_video11_model.dart';
export 'web_dev_video11_model.dart';

class WebDevVideo11Widget extends StatefulWidget {
  const WebDevVideo11Widget({Key? key}) : super(key: key);

  @override
  _WebDevVideo11WidgetState createState() => _WebDevVideo11WidgetState();
}

class _WebDevVideo11WidgetState extends State<WebDevVideo11Widget> {
  late WebDevVideo11Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => WebDevVideo11Model());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'WebDevVideo_11'});
                        ...
                        child: Row(
                          ...
                          children: [
                            FlutterFlowIconButton(
                              ...
                              onPressed: () async {
                                logFirebaseEvent(
                                    'WEB_DEV_VIDEO_11_arrow_back_ICN_ON_TAP');
