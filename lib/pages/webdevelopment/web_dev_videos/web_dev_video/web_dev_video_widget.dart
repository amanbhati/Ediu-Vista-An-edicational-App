...
import 'web_dev_video_model.dart';
export 'web_dev_video_model.dart';

class WebDevVideoWidget extends StatefulWidget {
  const WebDevVideoWidget({Key? key}) : super(key: key);

  @override
  _WebDevVideoWidgetState createState() => _WebDevVideoWidgetState();
}

class _WebDevVideoWidgetState extends State<WebDevVideoWidget> {
  late WebDevVideoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => WebDevVideoModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'WebDev_Video'});
                        ...
                        child: Row(
                          ...
                          children: [
                            FlutterFlowIconButton(
                              ...
                              onPressed: () async {
                                logFirebaseEvent(
                                    'WEB_DEV_VIDEO_PAGE_arrow_back_ICN_ON_TAP');
