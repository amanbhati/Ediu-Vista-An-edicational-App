...
import 'web_dev_video6_model.dart';
export 'web_dev_video6_model.dart';

class WebDevVideo6Widget extends StatefulWidget {
  const WebDevVideo6Widget({Key? key}) : super(key: key);

  @override
  _WebDevVideo6WidgetState createState() => _WebDevVideo6WidgetState();
}

class _WebDevVideo6WidgetState extends State<WebDevVideo6Widget> {
  late WebDevVideo6Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => WebDevVideo6Model());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'WebDevVideo_6'});
                        ...
                        child: Row(
                          ...
                          children: [
                            FlutterFlowIconButton(
                              ...
                              onPressed: () async {
                                logFirebaseEvent(
                                    'WEB_DEV_VIDEO_6_arrow_back_ICN_ON_TAP');
