...
import 'web_dev_video13_model.dart';
export 'web_dev_video13_model.dart';

class WebDevVideo13Widget extends StatefulWidget {
  const WebDevVideo13Widget({Key? key}) : super(key: key);

  @override
  _WebDevVideo13WidgetState createState() => _WebDevVideo13WidgetState();
}

class _WebDevVideo13WidgetState extends State<WebDevVideo13Widget> {
  late WebDevVideo13Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => WebDevVideo13Model());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'WebDevVideo_13'});
                        ...
                        child: Row(
                          ...
                          children: [
                            FlutterFlowIconButton(
                              ...
                              onPressed: () async {
                                logFirebaseEvent(
                                    'WEB_DEV_VIDEO_13_arrow_back_ICN_ON_TAP');
