...
import 'web_dev_video8_model.dart';
export 'web_dev_video8_model.dart';

class WebDevVideo8Widget extends StatefulWidget {
  const WebDevVideo8Widget({Key? key}) : super(key: key);

  @override
  _WebDevVideo8WidgetState createState() => _WebDevVideo8WidgetState();
}

class _WebDevVideo8WidgetState extends State<WebDevVideo8Widget> {
  late WebDevVideo8Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => WebDevVideo8Model());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'WebDevVideo_8'});
                        ...
                        child: Row(
                          ...
                          children: [
                            FlutterFlowIconButton(
                              ...
                              onPressed: () async {
                                logFirebaseEvent(
                                    'WEB_DEV_VIDEO_8_arrow_back_ICN_ON_TAP');
