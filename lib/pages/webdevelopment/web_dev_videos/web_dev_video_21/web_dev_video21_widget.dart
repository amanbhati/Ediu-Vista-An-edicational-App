...
import 'web_dev_video21_model.dart';
export 'web_dev_video21_model.dart';

class WebDevVideo21Widget extends StatefulWidget {
  const WebDevVideo21Widget({Key? key}) : super(key: key);

  @override
  _WebDevVideo21WidgetState createState() => _WebDevVideo21WidgetState();
}

class _WebDevVideo21WidgetState extends State<WebDevVideo21Widget> {
  late WebDevVideo21Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => WebDevVideo21Model());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'WebDevVideo_21'});
                        ...
                        child: Row(
                          ...
                          children: [
                            FlutterFlowIconButton(
                              ...
                              onPressed: () async {
                                logFirebaseEvent(
                                    'WEB_DEV_VIDEO_21_arrow_back_ICN_ON_TAP');
