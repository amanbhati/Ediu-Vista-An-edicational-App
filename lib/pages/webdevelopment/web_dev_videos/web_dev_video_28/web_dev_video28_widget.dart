...
import 'web_dev_video28_model.dart';
export 'web_dev_video28_model.dart';

class WebDevVideo28Widget extends StatefulWidget {
  const WebDevVideo28Widget({Key? key}) : super(key: key);

  @override
  _WebDevVideo28WidgetState createState() => _WebDevVideo28WidgetState();
}

class _WebDevVideo28WidgetState extends State<WebDevVideo28Widget> {
  late WebDevVideo28Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => WebDevVideo28Model());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'WebDevVideo_28'});
                        ...
                        child: Row(
                          ...
                          children: [
                            FlutterFlowIconButton(
                              ...
                              onPressed: () async {
                                logFirebaseEvent(
                                    'WEB_DEV_VIDEO_28_arrow_back_ICN_ON_TAP');
