...
import 'web_dev_video25_model.dart';
export 'web_dev_video25_model.dart';

class WebDevVideo25Widget extends StatefulWidget {
  const WebDevVideo25Widget({Key? key}) : super(key: key);

  @override
  _WebDevVideo25WidgetState createState() => _WebDevVideo25WidgetState();
}

class _WebDevVideo25WidgetState extends State<WebDevVideo25Widget> {
  late WebDevVideo25Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => WebDevVideo25Model());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'WebDevVideo_25'});
                        ...
                        child: Row(
                          ...
                          children: [
                            FlutterFlowIconButton(
                              ...
                              onPressed: () async {
                                logFirebaseEvent(
                                    'WEB_DEV_VIDEO_25_arrow_back_ICN_ON_TAP');
