...
import 'web_dev_video9_model.dart';
export 'web_dev_video9_model.dart';

class WebDevVideo9Widget extends StatefulWidget {
  const WebDevVideo9Widget({Key? key}) : super(key: key);

  @override
  _WebDevVideo9WidgetState createState() => _WebDevVideo9WidgetState();
}

class _WebDevVideo9WidgetState extends State<WebDevVideo9Widget> {
  late WebDevVideo9Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => WebDevVideo9Model());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'WebDevVideo_9'});
                        ...
                        child: Row(
                          ...
                          children: [
                            FlutterFlowIconButton(
                              ...
                              onPressed: () async {
                                logFirebaseEvent(
                                    'WEB_DEV_VIDEO_9_arrow_back_ICN_ON_TAP');
