...
import 'web_dev_video7_model.dart';
export 'web_dev_video7_model.dart';

class WebDevVideo7Widget extends StatefulWidget {
  const WebDevVideo7Widget({Key? key}) : super(key: key);

  @override
  _WebDevVideo7WidgetState createState() => _WebDevVideo7WidgetState();
}

class _WebDevVideo7WidgetState extends State<WebDevVideo7Widget> {
  late WebDevVideo7Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => WebDevVideo7Model());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'WebDevVideo_7'});
                        ...
                        child: Row(
                          ...
                          children: [
                            FlutterFlowIconButton(
                              ...
                              onPressed: () async {
                                logFirebaseEvent(
                                    'WEB_DEV_VIDEO_7_arrow_back_ICN_ON_TAP');
