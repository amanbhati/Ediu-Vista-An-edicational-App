...
import 'web_dev_video12_model.dart';
export 'web_dev_video12_model.dart';

class WebDevVideo12Widget extends StatefulWidget {
  const WebDevVideo12Widget({Key? key}) : super(key: key);

  @override
  _WebDevVideo12WidgetState createState() => _WebDevVideo12WidgetState();
}

class _WebDevVideo12WidgetState extends State<WebDevVideo12Widget> {
  late WebDevVideo12Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => WebDevVideo12Model());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'WebDevVideo_12'});
                        ...
                        child: Row(
                          ...
                          children: [
                            FlutterFlowIconButton(
                              ...
                              onPressed: () async {
                                logFirebaseEvent(
                                    'WEB_DEV_VIDEO_12_arrow_back_ICN_ON_TAP');
