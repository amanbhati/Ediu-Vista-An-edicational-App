...
import 'web_dev_video4_model.dart';
export 'web_dev_video4_model.dart';

class WebDevVideo4Widget extends StatefulWidget {
  const WebDevVideo4Widget({Key? key}) : super(key: key);

  @override
  _WebDevVideo4WidgetState createState() => _WebDevVideo4WidgetState();
}

class _WebDevVideo4WidgetState extends State<WebDevVideo4Widget> {
  late WebDevVideo4Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => WebDevVideo4Model());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'WebDevVideo_4'});
                        ...
                        child: Row(
                          ...
                          children: [
                            FlutterFlowIconButton(
                              ...
                              onPressed: () async {
                                logFirebaseEvent(
                                    'WEB_DEV_VIDEO_4_arrow_back_ICN_ON_TAP');
