...
import 'web_dev_video5_model.dart';
export 'web_dev_video5_model.dart';

class WebDevVideo5Widget extends StatefulWidget {
  const WebDevVideo5Widget({Key? key}) : super(key: key);

  @override
  _WebDevVideo5WidgetState createState() => _WebDevVideo5WidgetState();
}

class _WebDevVideo5WidgetState extends State<WebDevVideo5Widget> {
  late WebDevVideo5Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => WebDevVideo5Model());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'WebDevVideo_5'});
                        ...
                        child: Row(
                          ...
                          children: [
                            FlutterFlowIconButton(
                              ...
                              onPressed: () async {
                                logFirebaseEvent(
                                    'WEB_DEV_VIDEO_5_arrow_back_ICN_ON_TAP');
