...
import 'web_dev_video17_model.dart';
export 'web_dev_video17_model.dart';

class WebDevVideo17Widget extends StatefulWidget {
  const WebDevVideo17Widget({Key? key}) : super(key: key);

  @override
  _WebDevVideo17WidgetState createState() => _WebDevVideo17WidgetState();
}

class _WebDevVideo17WidgetState extends State<WebDevVideo17Widget> {
  late WebDevVideo17Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => WebDevVideo17Model());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'WebDevVideo_17'});
                        ...
                        child: Row(
                          ...
                          children: [
                            FlutterFlowIconButton(
                              ...
                              onPressed: () async {
                                logFirebaseEvent(
                                    'WEB_DEV_VIDEO_17_arrow_back_ICN_ON_TAP');
