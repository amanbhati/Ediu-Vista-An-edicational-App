...
import 'web_dev_video19_model.dart';
export 'web_dev_video19_model.dart';

class WebDevVideo19Widget extends StatefulWidget {
  const WebDevVideo19Widget({Key? key}) : super(key: key);

  @override
  _WebDevVideo19WidgetState createState() => _WebDevVideo19WidgetState();
}

class _WebDevVideo19WidgetState extends State<WebDevVideo19Widget> {
  late WebDevVideo19Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => WebDevVideo19Model());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'WebDevVideo_19'});
                        ...
                        child: Row(
                          ...
                          children: [
                            FlutterFlowIconButton(
                              ...
                              onPressed: () async {
                                logFirebaseEvent(
                                    'WEB_DEV_VIDEO_19_arrow_back_ICN_ON_TAP');
