...
import 'web_dev_video31_model.dart';
export 'web_dev_video31_model.dart';

class WebDevVideo31Widget extends StatefulWidget {
  const WebDevVideo31Widget({Key? key}) : super(key: key);

  @override
  _WebDevVideo31WidgetState createState() => _WebDevVideo31WidgetState();
}

class _WebDevVideo31WidgetState extends State<WebDevVideo31Widget> {
  late WebDevVideo31Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => WebDevVideo31Model());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'WebDevVideo_31'});
                        ...
                        child: Row(
                          ...
                          children: [
                            FlutterFlowIconButton(
                              ...
                              onPressed: () async {
                                logFirebaseEvent(
                                    'WEB_DEV_VIDEO_31_arrow_back_ICN_ON_TAP');
