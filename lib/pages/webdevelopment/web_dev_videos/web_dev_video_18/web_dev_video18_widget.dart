...
import 'web_dev_video18_model.dart';
export 'web_dev_video18_model.dart';

class WebDevVideo18Widget extends StatefulWidget {
  const WebDevVideo18Widget({Key? key}) : super(key: key);

  @override
  _WebDevVideo18WidgetState createState() => _WebDevVideo18WidgetState();
}

class _WebDevVideo18WidgetState extends State<WebDevVideo18Widget> {
  late WebDevVideo18Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => WebDevVideo18Model());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'WebDevVideo_18'});
                        ...
                        child: Row(
                          ...
                          children: [
                            FlutterFlowIconButton(
                              ...
                              onPressed: () async {
                                logFirebaseEvent(
                                    'WEB_DEV_VIDEO_18_arrow_back_ICN_ON_TAP');
