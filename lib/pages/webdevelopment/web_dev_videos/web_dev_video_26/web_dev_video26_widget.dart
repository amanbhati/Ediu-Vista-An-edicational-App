...
import 'web_dev_video26_model.dart';
export 'web_dev_video26_model.dart';

class WebDevVideo26Widget extends StatefulWidget {
  const WebDevVideo26Widget({Key? key}) : super(key: key);

  @override
  _WebDevVideo26WidgetState createState() => _WebDevVideo26WidgetState();
}

class _WebDevVideo26WidgetState extends State<WebDevVideo26Widget> {
  late WebDevVideo26Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => WebDevVideo26Model());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'WebDevVideo_26'});
                        ...
                        child: Row(
                          ...
                          children: [
                            FlutterFlowIconButton(
                              ...
                              onPressed: () async {
                                logFirebaseEvent(
                                    'WEB_DEV_VIDEO_26_arrow_back_ICN_ON_TAP');
