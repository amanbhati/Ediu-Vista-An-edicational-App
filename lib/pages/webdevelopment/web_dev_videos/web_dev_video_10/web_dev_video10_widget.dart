...
import 'web_dev_video10_model.dart';
export 'web_dev_video10_model.dart';

class WebDevVideo10Widget extends StatefulWidget {
  const WebDevVideo10Widget({Key? key}) : super(key: key);

  @override
  _WebDevVideo10WidgetState createState() => _WebDevVideo10WidgetState();
}

class _WebDevVideo10WidgetState extends State<WebDevVideo10Widget> {
  late WebDevVideo10Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => WebDevVideo10Model());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'WebDevVideo_10'});
                        ...
                        child: Row(
                          ...
                          children: [
                            FlutterFlowIconButton(
                              ...
                              onPressed: () async {
                                logFirebaseEvent(
                                    'WEB_DEV_VIDEO_10_arrow_back_ICN_ON_TAP');
