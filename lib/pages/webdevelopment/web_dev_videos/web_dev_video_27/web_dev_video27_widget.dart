...
import 'web_dev_video27_model.dart';
export 'web_dev_video27_model.dart';

class WebDevVideo27Widget extends StatefulWidget {
  const WebDevVideo27Widget({Key? key}) : super(key: key);

  @override
  _WebDevVideo27WidgetState createState() => _WebDevVideo27WidgetState();
}

class _WebDevVideo27WidgetState extends State<WebDevVideo27Widget> {
  late WebDevVideo27Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => WebDevVideo27Model());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'WebDevVideo_27'});
                        ...
                        child: Row(
                          ...
                          children: [
                            FlutterFlowIconButton(
                              ...
                              onPressed: () async {
                                logFirebaseEvent(
                                    'WEB_DEV_VIDEO_27_arrow_back_ICN_ON_TAP');
