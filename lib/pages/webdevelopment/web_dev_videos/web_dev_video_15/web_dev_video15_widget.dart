...
import 'web_dev_video15_model.dart';
export 'web_dev_video15_model.dart';

class WebDevVideo15Widget extends StatefulWidget {
  const WebDevVideo15Widget({Key? key}) : super(key: key);

  @override
  _WebDevVideo15WidgetState createState() => _WebDevVideo15WidgetState();
}

class _WebDevVideo15WidgetState extends State<WebDevVideo15Widget> {
  late WebDevVideo15Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => WebDevVideo15Model());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'WebDevVideo_15'});
                        ...
                        child: Row(
                          ...
                          children: [
                            FlutterFlowIconButton(
                              ...
                              onPressed: () async {
                                logFirebaseEvent(
                                    'WEB_DEV_VIDEO_15_arrow_back_ICN_ON_TAP');
