...
import 'web_dev_video14_model.dart';
export 'web_dev_video14_model.dart';

class WebDevVideo14Widget extends StatefulWidget {
  const WebDevVideo14Widget({Key? key}) : super(key: key);

  @override
  _WebDevVideo14WidgetState createState() => _WebDevVideo14WidgetState();
}

class _WebDevVideo14WidgetState extends State<WebDevVideo14Widget> {
  late WebDevVideo14Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => WebDevVideo14Model());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'WebDevVideo_14'});
                        ...
                        child: Row(
                          ...
                          children: [
                            FlutterFlowIconButton(
                              ...
                              onPressed: () async {
                                logFirebaseEvent(
                                    'WEB_DEV_VIDEO_14_arrow_back_ICN_ON_TAP');
