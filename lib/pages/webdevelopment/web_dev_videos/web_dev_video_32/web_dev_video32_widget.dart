...
import 'web_dev_video32_model.dart';
export 'web_dev_video32_model.dart';

class WebDevVideo32Widget extends StatefulWidget {
  const WebDevVideo32Widget({Key? key}) : super(key: key);

  @override
  _WebDevVideo32WidgetState createState() => _WebDevVideo32WidgetState();
}

class _WebDevVideo32WidgetState extends State<WebDevVideo32Widget> {
  late WebDevVideo32Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => WebDevVideo32Model());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'WebDevVideo_32'});
                        ...
                        child: Row(
                          ...
                          children: [
                            FlutterFlowIconButton(
                              ...
                              onPressed: () async {
                                logFirebaseEvent(
                                    'WEB_DEV_VIDEO_32_arrow_back_ICN_ON_TAP');
