...
import 'web_dev_video20_model.dart';
export 'web_dev_video20_model.dart';

class WebDevVideo20Widget extends StatefulWidget {
  const WebDevVideo20Widget({Key? key}) : super(key: key);

  @override
  _WebDevVideo20WidgetState createState() => _WebDevVideo20WidgetState();
}

class _WebDevVideo20WidgetState extends State<WebDevVideo20Widget> {
  late WebDevVideo20Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => WebDevVideo20Model());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'WebDevVideo_20'});
                        ...
                        child: Row(
                          ...
                          children: [
                            FlutterFlowIconButton(
                              ...
                              onPressed: () async {
                                logFirebaseEvent(
                                    'WEB_DEV_VIDEO_20_arrow_back_ICN_ON_TAP');
