...
import 'web_dev_video24_model.dart';
export 'web_dev_video24_model.dart';

class WebDevVideo24Widget extends StatefulWidget {
  const WebDevVideo24Widget({Key? key}) : super(key: key);

  @override
  _WebDevVideo24WidgetState createState() => _WebDevVideo24WidgetState();
}

class _WebDevVideo24WidgetState extends State<WebDevVideo24Widget> {
  late WebDevVideo24Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => WebDevVideo24Model());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'WebDevVideo_24'});
                        ...
                        child: Row(
                          ...
                          children: [
                            FlutterFlowIconButton(
                              ...
                              onPressed: () async {
                                logFirebaseEvent(
                                    'WEB_DEV_VIDEO_24_arrow_back_ICN_ON_TAP');
