...
import 'web_dev_video16_model.dart';
export 'web_dev_video16_model.dart';

class WebDevVideo16Widget extends StatefulWidget {
  const WebDevVideo16Widget({Key? key}) : super(key: key);

  @override
  _WebDevVideo16WidgetState createState() => _WebDevVideo16WidgetState();
}

class _WebDevVideo16WidgetState extends State<WebDevVideo16Widget> {
  late WebDevVideo16Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => WebDevVideo16Model());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'WebDevVideo_16'});
                        ...
                        child: Row(
                          ...
                          children: [
                            FlutterFlowIconButton(
                              ...
                              onPressed: () async {
                                logFirebaseEvent(
                                    'WEB_DEV_VIDEO_16_arrow_back_ICN_ON_TAP');
