...
import 'web_dev_video2_model.dart';
export 'web_dev_video2_model.dart';

class WebDevVideo2Widget extends StatefulWidget {
  const WebDevVideo2Widget({Key? key}) : super(key: key);

  @override
  _WebDevVideo2WidgetState createState() => _WebDevVideo2WidgetState();
}

class _WebDevVideo2WidgetState extends State<WebDevVideo2Widget> {
  late WebDevVideo2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => WebDevVideo2Model());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'WebDevVideo_2'});
                        ...
                        child: Row(
                          ...
                          children: [
                            FlutterFlowIconButton(
                              ...
                              onPressed: () async {
                                logFirebaseEvent(
                                    'WEB_DEV_VIDEO_2_arrow_back_ICN_ON_TAP');
                                    ...
                                    children: [
                                      Padding(
                                        ...
                                        child: InkWell(
                                          ...
                                          onTap: () async {
                                            logFirebaseEvent(
                                                'WEB_DEV_VIDEO_2_PAGE_Row_28qv1glh_ON_TAP');
