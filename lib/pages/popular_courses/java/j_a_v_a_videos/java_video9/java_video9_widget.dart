...
import 'java_video9_model.dart';
export 'java_video9_model.dart';

class JavaVideo9Widget extends StatefulWidget {
  const JavaVideo9Widget({Key? key}) : super(key: key);

  @override
  _JavaVideo9WidgetState createState() => _JavaVideo9WidgetState();
}

class _JavaVideo9WidgetState extends State<JavaVideo9Widget> {
  late JavaVideo9Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => JavaVideo9Model());

    logFirebaseEvent('screen_view', parameters: {'screen_name': 'JavaVideo9'});
                        ...
                        child: Row(
                          ...
                          children: [
                            FlutterFlowIconButton(
                              ...
                              onPressed: () async {
                                logFirebaseEvent(
                                    'JAVA_VIDEO9_PAGE_arrow_back_ICN_ON_TAP');
