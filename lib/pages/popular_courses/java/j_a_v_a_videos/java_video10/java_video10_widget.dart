...
import 'java_video10_model.dart';
export 'java_video10_model.dart';

class JavaVideo10Widget extends StatefulWidget {
  const JavaVideo10Widget({Key? key}) : super(key: key);

  @override
  _JavaVideo10WidgetState createState() => _JavaVideo10WidgetState();
}

class _JavaVideo10WidgetState extends State<JavaVideo10Widget> {
  late JavaVideo10Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => JavaVideo10Model());

    logFirebaseEvent('screen_view', parameters: {'screen_name': 'JavaVideo10'});
                        ...
                        child: Row(
                          ...
                          children: [
                            FlutterFlowIconButton(
                              ...
                              onPressed: () async {
                                logFirebaseEvent(
                                    'JAVA_VIDEO10_PAGE_arrow_back_ICN_ON_TAP');
