...
import 'java_video11_model.dart';
export 'java_video11_model.dart';

class JavaVideo11Widget extends StatefulWidget {
  const JavaVideo11Widget({Key? key}) : super(key: key);

  @override
  _JavaVideo11WidgetState createState() => _JavaVideo11WidgetState();
}

class _JavaVideo11WidgetState extends State<JavaVideo11Widget> {
  late JavaVideo11Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => JavaVideo11Model());

    logFirebaseEvent('screen_view', parameters: {'screen_name': 'JavaVideo11'});
                        ...
                        child: Row(
                          ...
                          children: [
                            FlutterFlowIconButton(
                              ...
                              onPressed: () async {
                                logFirebaseEvent(
                                    'JAVA_VIDEO11_PAGE_arrow_back_ICN_ON_TAP');
