...
import 'java_video25_model.dart';
export 'java_video25_model.dart';

class JavaVideo25Widget extends StatefulWidget {
  const JavaVideo25Widget({Key? key}) : super(key: key);

  @override
  _JavaVideo25WidgetState createState() => _JavaVideo25WidgetState();
}

class _JavaVideo25WidgetState extends State<JavaVideo25Widget> {
  late JavaVideo25Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => JavaVideo25Model());

    logFirebaseEvent('screen_view', parameters: {'screen_name': 'JavaVideo25'});
                        ...
                        child: Row(
                          ...
                          children: [
                            FlutterFlowIconButton(
                              ...
                              onPressed: () async {
                                logFirebaseEvent(
                                    'JAVA_VIDEO25_PAGE_arrow_back_ICN_ON_TAP');
