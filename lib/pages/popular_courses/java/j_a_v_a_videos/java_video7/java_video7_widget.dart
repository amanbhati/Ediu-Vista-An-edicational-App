...
import 'java_video7_model.dart';
export 'java_video7_model.dart';

class JavaVideo7Widget extends StatefulWidget {
  const JavaVideo7Widget({Key? key}) : super(key: key);

  @override
  _JavaVideo7WidgetState createState() => _JavaVideo7WidgetState();
}

class _JavaVideo7WidgetState extends State<JavaVideo7Widget> {
  late JavaVideo7Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => JavaVideo7Model());

    logFirebaseEvent('screen_view', parameters: {'screen_name': 'JavaVideo7'});
                        ...
                        child: Row(
                          ...
                          children: [
                            FlutterFlowIconButton(
                              ...
                              onPressed: () async {
                                logFirebaseEvent(
                                    'JAVA_VIDEO7_PAGE_arrow_back_ICN_ON_TAP');
