...
import 'java_video5_model.dart';
export 'java_video5_model.dart';

class JavaVideo5Widget extends StatefulWidget {
  const JavaVideo5Widget({Key? key}) : super(key: key);

  @override
  _JavaVideo5WidgetState createState() => _JavaVideo5WidgetState();
}

class _JavaVideo5WidgetState extends State<JavaVideo5Widget> {
  late JavaVideo5Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => JavaVideo5Model());

    logFirebaseEvent('screen_view', parameters: {'screen_name': 'JavaVideo5'});
                        ...
                        child: Row(
                          ...
                          children: [
                            FlutterFlowIconButton(
                              ...
                              onPressed: () async {
                                logFirebaseEvent(
                                    'JAVA_VIDEO5_PAGE_arrow_back_ICN_ON_TAP');
