...
import 'java_video21_model.dart';
export 'java_video21_model.dart';

class JavaVideo21Widget extends StatefulWidget {
  const JavaVideo21Widget({Key? key}) : super(key: key);

  @override
  _JavaVideo21WidgetState createState() => _JavaVideo21WidgetState();
}

class _JavaVideo21WidgetState extends State<JavaVideo21Widget> {
  late JavaVideo21Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => JavaVideo21Model());

    logFirebaseEvent('screen_view', parameters: {'screen_name': 'JavaVideo21'});
                        ...
                        child: Row(
                          ...
                          children: [
                            FlutterFlowIconButton(
                              ...
                              onPressed: () async {
                                logFirebaseEvent(
                                    'JAVA_VIDEO21_PAGE_arrow_back_ICN_ON_TAP');
