...
import 'java_video17_model.dart';
export 'java_video17_model.dart';

class JavaVideo17Widget extends StatefulWidget {
  const JavaVideo17Widget({Key? key}) : super(key: key);

  @override
  _JavaVideo17WidgetState createState() => _JavaVideo17WidgetState();
}

class _JavaVideo17WidgetState extends State<JavaVideo17Widget> {
  late JavaVideo17Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => JavaVideo17Model());

    logFirebaseEvent('screen_view', parameters: {'screen_name': 'JavaVideo17'});
                        ...
                        child: Row(
                          ...
                          children: [
                            FlutterFlowIconButton(
                              ...
                              onPressed: () async {
                                logFirebaseEvent(
                                    'JAVA_VIDEO17_PAGE_arrow_back_ICN_ON_TAP');
