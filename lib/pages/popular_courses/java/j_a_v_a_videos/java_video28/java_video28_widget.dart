...
import 'java_video28_model.dart';
export 'java_video28_model.dart';

class JavaVideo28Widget extends StatefulWidget {
  const JavaVideo28Widget({Key? key}) : super(key: key);

  @override
  _JavaVideo28WidgetState createState() => _JavaVideo28WidgetState();
}

class _JavaVideo28WidgetState extends State<JavaVideo28Widget> {
  late JavaVideo28Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => JavaVideo28Model());

    logFirebaseEvent('screen_view', parameters: {'screen_name': 'JavaVideo28'});
                        ...
                        child: Row(
                          ...
                          children: [
                            FlutterFlowIconButton(
                              ...
                              onPressed: () async {
                                logFirebaseEvent(
                                    'JAVA_VIDEO28_PAGE_arrow_back_ICN_ON_TAP');
