...
import 'java_video13_model.dart';
export 'java_video13_model.dart';

class JavaVideo13Widget extends StatefulWidget {
  const JavaVideo13Widget({Key? key}) : super(key: key);

  @override
  _JavaVideo13WidgetState createState() => _JavaVideo13WidgetState();
}

class _JavaVideo13WidgetState extends State<JavaVideo13Widget> {
  late JavaVideo13Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => JavaVideo13Model());

    logFirebaseEvent('screen_view', parameters: {'screen_name': 'JavaVideo13'});
                        ...
                        child: Row(
                          ...
                          children: [
                            FlutterFlowIconButton(
                              ...
                              onPressed: () async {
                                logFirebaseEvent(
                                    'JAVA_VIDEO13_PAGE_arrow_back_ICN_ON_TAP');
