...
import 'java_video3_model.dart';
export 'java_video3_model.dart';

class JavaVideo3Widget extends StatefulWidget {
  const JavaVideo3Widget({Key? key}) : super(key: key);

  @override
  _JavaVideo3WidgetState createState() => _JavaVideo3WidgetState();
}

class _JavaVideo3WidgetState extends State<JavaVideo3Widget> {
  late JavaVideo3Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => JavaVideo3Model());

    logFirebaseEvent('screen_view', parameters: {'screen_name': 'JavaVideo3'});
                        ...
                        child: Row(
                          ...
                          children: [
                            FlutterFlowIconButton(
                              ...
                              onPressed: () async {
                                logFirebaseEvent(
                                    'JAVA_VIDEO3_PAGE_arrow_back_ICN_ON_TAP');
                                    ...
                                    children: [
                                      Padding(
                                        ...
                                        child: InkWell(
                                          ...
                                          onTap: () async {
                                            logFirebaseEvent(
                                                'JAVA_VIDEO3_PAGE_Row_f34xvf2k_ON_TAP');
