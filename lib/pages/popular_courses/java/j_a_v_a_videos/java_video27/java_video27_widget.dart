...
import 'java_video27_model.dart';
export 'java_video27_model.dart';

class JavaVideo27Widget extends StatefulWidget {
  const JavaVideo27Widget({Key? key}) : super(key: key);

  @override
  _JavaVideo27WidgetState createState() => _JavaVideo27WidgetState();
}

class _JavaVideo27WidgetState extends State<JavaVideo27Widget> {
  late JavaVideo27Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => JavaVideo27Model());

    logFirebaseEvent('screen_view', parameters: {'screen_name': 'JavaVideo27'});
                        ...
                        child: Row(
                          ...
                          children: [
                            FlutterFlowIconButton(
                              ...
                              onPressed: () async {
                                logFirebaseEvent(
                                    'JAVA_VIDEO27_PAGE_arrow_back_ICN_ON_TAP');
