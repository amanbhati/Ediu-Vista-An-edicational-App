...
import 'java_video26_model.dart';
export 'java_video26_model.dart';

class JavaVideo26Widget extends StatefulWidget {
  const JavaVideo26Widget({Key? key}) : super(key: key);

  @override
  _JavaVideo26WidgetState createState() => _JavaVideo26WidgetState();
}

class _JavaVideo26WidgetState extends State<JavaVideo26Widget> {
  late JavaVideo26Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => JavaVideo26Model());

    logFirebaseEvent('screen_view', parameters: {'screen_name': 'JavaVideo26'});
                        ...
                        child: Row(
                          ...
                          children: [
                            FlutterFlowIconButton(
                              ...
                              onPressed: () async {
                                logFirebaseEvent(
                                    'JAVA_VIDEO26_PAGE_arrow_back_ICN_ON_TAP');
