...
import 'java_video22_model.dart';
export 'java_video22_model.dart';

class JavaVideo22Widget extends StatefulWidget {
  const JavaVideo22Widget({Key? key}) : super(key: key);

  @override
  _JavaVideo22WidgetState createState() => _JavaVideo22WidgetState();
}

class _JavaVideo22WidgetState extends State<JavaVideo22Widget> {
  late JavaVideo22Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => JavaVideo22Model());

    logFirebaseEvent('screen_view', parameters: {'screen_name': 'JavaVideo22'});
                        ...
                        child: Row(
                          ...
                          children: [
                            FlutterFlowIconButton(
                              ...
                              onPressed: () async {
                                logFirebaseEvent(
                                    'JAVA_VIDEO22_PAGE_arrow_back_ICN_ON_TAP');
