...
import 'java_video15_model.dart';
export 'java_video15_model.dart';

class JavaVideo15Widget extends StatefulWidget {
  const JavaVideo15Widget({Key? key}) : super(key: key);

  @override
  _JavaVideo15WidgetState createState() => _JavaVideo15WidgetState();
}

class _JavaVideo15WidgetState extends State<JavaVideo15Widget> {
  late JavaVideo15Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => JavaVideo15Model());

    logFirebaseEvent('screen_view', parameters: {'screen_name': 'JavaVideo15'});
                        ...
                        child: Row(
                          ...
                          children: [
                            FlutterFlowIconButton(
                              ...
                              onPressed: () async {
                                logFirebaseEvent(
                                    'JAVA_VIDEO15_PAGE_arrow_back_ICN_ON_TAP');
