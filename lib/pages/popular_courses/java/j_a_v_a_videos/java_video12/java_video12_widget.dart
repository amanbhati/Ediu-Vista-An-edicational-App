...
import 'java_video12_model.dart';
export 'java_video12_model.dart';

class JavaVideo12Widget extends StatefulWidget {
  const JavaVideo12Widget({Key? key}) : super(key: key);

  @override
  _JavaVideo12WidgetState createState() => _JavaVideo12WidgetState();
}

class _JavaVideo12WidgetState extends State<JavaVideo12Widget> {
  late JavaVideo12Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => JavaVideo12Model());

    logFirebaseEvent('screen_view', parameters: {'screen_name': 'JavaVideo12'});
                        ...
                        child: Row(
                          ...
                          children: [
                            FlutterFlowIconButton(
                              ...
                              onPressed: () async {
                                logFirebaseEvent(
                                    'JAVA_VIDEO12_PAGE_arrow_back_ICN_ON_TAP');
