...
import 'java_video23_model.dart';
export 'java_video23_model.dart';

class JavaVideo23Widget extends StatefulWidget {
  const JavaVideo23Widget({Key? key}) : super(key: key);

  @override
  _JavaVideo23WidgetState createState() => _JavaVideo23WidgetState();
}

class _JavaVideo23WidgetState extends State<JavaVideo23Widget> {
  late JavaVideo23Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => JavaVideo23Model());

    logFirebaseEvent('screen_view', parameters: {'screen_name': 'JavaVideo23'});
                        ...
                        child: Row(
                          ...
                          children: [
                            FlutterFlowIconButton(
                              ...
                              onPressed: () async {
                                logFirebaseEvent(
                                    'JAVA_VIDEO23_PAGE_arrow_back_ICN_ON_TAP');
