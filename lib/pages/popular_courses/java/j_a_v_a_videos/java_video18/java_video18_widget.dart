...
import 'java_video18_model.dart';
export 'java_video18_model.dart';

class JavaVideo18Widget extends StatefulWidget {
  const JavaVideo18Widget({Key? key}) : super(key: key);

  @override
  _JavaVideo18WidgetState createState() => _JavaVideo18WidgetState();
}

class _JavaVideo18WidgetState extends State<JavaVideo18Widget> {
  late JavaVideo18Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => JavaVideo18Model());

    logFirebaseEvent('screen_view', parameters: {'screen_name': 'JavaVideo18'});
                        ...
                        child: Row(
                          ...
                          children: [
                            FlutterFlowIconButton(
                              ...
                              onPressed: () async {
                                logFirebaseEvent(
                                    'JAVA_VIDEO18_PAGE_arrow_back_ICN_ON_TAP');
