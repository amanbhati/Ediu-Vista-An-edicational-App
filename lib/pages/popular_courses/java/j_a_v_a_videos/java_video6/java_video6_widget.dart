...
import 'java_video6_model.dart';
export 'java_video6_model.dart';

class JavaVideo6Widget extends StatefulWidget {
  const JavaVideo6Widget({Key? key}) : super(key: key);

  @override
  _JavaVideo6WidgetState createState() => _JavaVideo6WidgetState();
}

class _JavaVideo6WidgetState extends State<JavaVideo6Widget> {
  late JavaVideo6Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => JavaVideo6Model());

    logFirebaseEvent('screen_view', parameters: {'screen_name': 'JavaVideo6'});
                        ...
                        child: Row(
                          ...
                          children: [
                            FlutterFlowIconButton(
                              ...
                              onPressed: () async {
                                logFirebaseEvent(
                                    'JAVA_VIDEO6_PAGE_arrow_back_ICN_ON_TAP');
