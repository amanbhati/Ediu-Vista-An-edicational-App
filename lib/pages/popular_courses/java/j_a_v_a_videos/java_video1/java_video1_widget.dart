...
import 'java_video1_model.dart';
export 'java_video1_model.dart';

class JavaVideo1Widget extends StatefulWidget {
  const JavaVideo1Widget({Key? key}) : super(key: key);

  @override
  _JavaVideo1WidgetState createState() => _JavaVideo1WidgetState();
}

class _JavaVideo1WidgetState extends State<JavaVideo1Widget> {
  late JavaVideo1Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => JavaVideo1Model());

    logFirebaseEvent('screen_view', parameters: {'screen_name': 'JavaVideo1'});
                        ...
                        child: Row(
                          ...
                          children: [
                            FlutterFlowIconButton(
                              ...
                              onPressed: () async {
                                logFirebaseEvent(
                                    'JAVA_VIDEO1_PAGE_arrow_back_ICN_ON_TAP');
                                    ...
                                    children: [
                                      Padding(
                                        ...
                                        child: InkWell(
                                          ...
                                          onTap: () async {
                                            logFirebaseEvent(
                                                'JAVA_VIDEO1_PAGE_Row_hap37e1f_ON_TAP');
                                      ...
                                      Padding(
                                        ...
                                        child: InkWell(
                                          ...
                                          onTap: () async {
                                            logFirebaseEvent(
                                                'JAVA_VIDEO1_PAGE_Row_e405j87f_ON_TAP');
                                            logFirebaseEvent('Row_navigate_to');
                                      ...
                                      Padding(
                                        ...
                                        child: InkWell(
                                          ...
                                          onTap: () async {
                                            logFirebaseEvent(
                                                'JAVA_VIDEO1_PAGE_Row_7zz5esnv_ON_TAP');
                                            logFirebaseEvent('Row_navigate_to');
