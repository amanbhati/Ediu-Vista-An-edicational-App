...
import 'java_video20_model.dart';
export 'java_video20_model.dart';

class JavaVideo20Widget extends StatefulWidget {
  const JavaVideo20Widget({Key? key}) : super(key: key);

  @override
  _JavaVideo20WidgetState createState() => _JavaVideo20WidgetState();
}

class _JavaVideo20WidgetState extends State<JavaVideo20Widget> {
  late JavaVideo20Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => JavaVideo20Model());

    logFirebaseEvent('screen_view', parameters: {'screen_name': 'JavaVideo20'});
                        ...
                        child: Row(
                          ...
                          children: [
                            FlutterFlowIconButton(
                              ...
                              onPressed: () async {
                                logFirebaseEvent(
                                    'JAVA_VIDEO20_PAGE_arrow_back_ICN_ON_TAP');
