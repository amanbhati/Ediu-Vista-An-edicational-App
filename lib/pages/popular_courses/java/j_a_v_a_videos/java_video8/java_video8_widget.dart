...
import 'java_video8_model.dart';
export 'java_video8_model.dart';

class JavaVideo8Widget extends StatefulWidget {
  const JavaVideo8Widget({Key? key}) : super(key: key);

  @override
  _JavaVideo8WidgetState createState() => _JavaVideo8WidgetState();
}

class _JavaVideo8WidgetState extends State<JavaVideo8Widget> {
  late JavaVideo8Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => JavaVideo8Model());

    logFirebaseEvent('screen_view', parameters: {'screen_name': 'JavaVideo8'});
                        ...
                        child: Row(
                          ...
                          children: [
                            FlutterFlowIconButton(
                              ...
                              onPressed: () async {
                                logFirebaseEvent(
                                    'JAVA_VIDEO8_PAGE_arrow_back_ICN_ON_TAP');
