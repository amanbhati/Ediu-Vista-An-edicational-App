...
import 'java_video14_model.dart';
export 'java_video14_model.dart';

class JavaVideo14Widget extends StatefulWidget {
  const JavaVideo14Widget({Key? key}) : super(key: key);

  @override
  _JavaVideo14WidgetState createState() => _JavaVideo14WidgetState();
}

class _JavaVideo14WidgetState extends State<JavaVideo14Widget> {
  late JavaVideo14Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => JavaVideo14Model());

    logFirebaseEvent('screen_view', parameters: {'screen_name': 'JavaVideo14'});
                        ...
                        child: Row(
                          ...
                          children: [
                            FlutterFlowIconButton(
                              ...
                              onPressed: () async {
                                logFirebaseEvent(
                                    'JAVA_VIDEO14_PAGE_arrow_back_ICN_ON_TAP');
