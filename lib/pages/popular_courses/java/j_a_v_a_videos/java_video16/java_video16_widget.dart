...
import 'java_video16_model.dart';
export 'java_video16_model.dart';

class JavaVideo16Widget extends StatefulWidget {
  const JavaVideo16Widget({Key? key}) : super(key: key);

  @override
  _JavaVideo16WidgetState createState() => _JavaVideo16WidgetState();
}

class _JavaVideo16WidgetState extends State<JavaVideo16Widget> {
  late JavaVideo16Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => JavaVideo16Model());

    logFirebaseEvent('screen_view', parameters: {'screen_name': 'JavaVideo16'});
                        ...
                        child: Row(
                          ...
                          children: [
                            FlutterFlowIconButton(
                              ...
                              onPressed: () async {
                                logFirebaseEvent(
                                    'JAVA_VIDEO16_PAGE_arrow_back_ICN_ON_TAP');
