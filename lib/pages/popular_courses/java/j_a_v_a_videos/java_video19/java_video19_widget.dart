...
import 'java_video19_model.dart';
export 'java_video19_model.dart';

class JavaVideo19Widget extends StatefulWidget {
  const JavaVideo19Widget({Key? key}) : super(key: key);

  @override
  _JavaVideo19WidgetState createState() => _JavaVideo19WidgetState();
}

class _JavaVideo19WidgetState extends State<JavaVideo19Widget> {
  late JavaVideo19Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => JavaVideo19Model());

    logFirebaseEvent('screen_view', parameters: {'screen_name': 'JavaVideo19'});
                        ...
                        child: Row(
                          ...
                          children: [
                            FlutterFlowIconButton(
                              ...
                              onPressed: () async {
                                logFirebaseEvent(
                                    'JAVA_VIDEO19_PAGE_arrow_back_ICN_ON_TAP');
