...
import 'java_video4_model.dart';
export 'java_video4_model.dart';

class JavaVideo4Widget extends StatefulWidget {
  const JavaVideo4Widget({Key? key}) : super(key: key);

  @override
  _JavaVideo4WidgetState createState() => _JavaVideo4WidgetState();
}

class _JavaVideo4WidgetState extends State<JavaVideo4Widget> {
  late JavaVideo4Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => JavaVideo4Model());

    logFirebaseEvent('screen_view', parameters: {'screen_name': 'JavaVideo4'});
                        ...
                        child: Row(
                          ...
                          children: [
                            FlutterFlowIconButton(
                              ...
                              onPressed: () async {
                                logFirebaseEvent(
                                    'JAVA_VIDEO4_PAGE_arrow_back_ICN_ON_TAP');
