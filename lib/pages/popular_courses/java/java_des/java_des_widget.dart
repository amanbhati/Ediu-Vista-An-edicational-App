...
import 'java_des_model.dart';
export 'java_des_model.dart';

class JavaDesWidget extends StatefulWidget {
  const JavaDesWidget({Key? key}) : super(key: key);

  @override
  _JavaDesWidgetState createState() => _JavaDesWidgetState();
}

class _JavaDesWidgetState extends State<JavaDesWidget> {
  late JavaDesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => JavaDesModel());

    logFirebaseEvent('screen_view', parameters: {'screen_name': 'javaDes'});
