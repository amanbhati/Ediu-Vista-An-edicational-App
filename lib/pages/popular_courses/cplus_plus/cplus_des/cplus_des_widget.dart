...
import 'cplus_des_model.dart';
export 'cplus_des_model.dart';

class CplusDesWidget extends StatefulWidget {
  const CplusDesWidget({Key? key}) : super(key: key);

  @override
  _CplusDesWidgetState createState() => _CplusDesWidgetState();
}

class _CplusDesWidgetState extends State<CplusDesWidget> {
  late CplusDesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CplusDesModel());

    logFirebaseEvent('screen_view', parameters: {'screen_name': 'Cplus_des'});
